...
import (
	"transaction-processing/adapter/broker"
	"transaction-processing/domain/entity"
	"transaction-processing/domain/repository"
)
...
func NewProcessTransaction(repository repository.TransactionRepository, producerInterface broker.Producer, topic string) *ProcessTransaction {
